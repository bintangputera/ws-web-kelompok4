    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Content Row -->
          <form method="post" action="<?= $_ENV['admin_base_url'] ?>action/add-tentang.php" enctype="multipart/form-data">
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <textarea id="summernote" name="konten_tentang"></textarea>
                </div>
