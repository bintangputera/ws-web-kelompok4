...
<body>  
			...
			<div class="top-nav w3-agiletop">
				<div class="container">
					<div class="navbar-header w3llogo">
						...
						<h1><a href="index.php">Ida Batik</a></h1> 
					</div>
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<div class="w3menu navbar-right">
							<ul class="nav navbar">
								...
								<li><a href="#team" class="scroll">Tim Kami</a></li>
								<li><a href="#gallery" class="scroll">Galeri</a></li> 
								<li><a href="#blog" class="scroll">Blog</a></li>
								<li><a href="#contact" class="scroll">Kontak Kami</a></li> 
							</ul>
						</div> 
	...
	<!-- //banner --> 
	<!-- about -->
	<div id="about" class="about-w3agile">
		<div class="container">
			<h2 class="w3ls_head">Selamat Datang</h2>
	...
	<div id="team" class="about team">		
		<div class="container">
			<h3 class="w3ls_head">Tim Kami</h3>
			<p class="w3agile">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque
				corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident.</p>
			<div class="team-agileinfo w3-agile">
				<div class="col-md-3 col-sm-6 col-xs-6 team-grids w3-agile">
					<div class="thumbnail team-agileits">
						<img src="images/t1.jpg" class="img-responsive" alt="...">
						<div class="w3agile-caption w3-agile">
							<h4>Vaura Tegsner</h4>
	...
	<div id="gallery" class="gallery wthree">
		<div class="container">
			...
			<div class="gallery-agileinfo">
				...
				<div class="col-md-4 col-xs-4 gallery-w3bottom">
					<figure class="effect-bubba">
	...
	<div id="blog" class="blog services agile-blog">
		<div class="container"> 
			<h3 class="w3ls_head">Blog Kami</h3>
			<p class="w3agile">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque
				corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident.</p>
	...
	<div id="contact" class="contact">
		<div class="container"> 
			<h3 class="w3ls_head">Kontak Kami</h3>
			<p class="w3agile">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque
				corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident.</p>
			...
			<div class="map">
				<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15803.575504057128!2d113.8281551!3d-8.0098797!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x1e8aa1f722623275!2sIda%20Batik!5e0!3m2!1sen!2sid!4v1606320432253!5m2!1sen!2sid" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
			</div>
		</div>
	</div>
	<!-- //contact -->
	...
	<div class="w3l-footer">
		<div class="container">
			<div class="footer-w3logo"> 
				<a href="index.html">Bridal Dress</a>
			</div>
			...
			<div class="copyright-agile">
				<p>&copy; 2017 Bridal Dress. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts</a></p>
			</div>
		</div>
	</div>
	<!-- //footer --> 
