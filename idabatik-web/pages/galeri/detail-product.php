                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="product-details">
                                ...
                                <ul class="pd-tags">
                                    <li><span>Kategori</span>: <?= $produk['jenis_produk'] ?> </li>
                                </ul>
                                <div class="pd-share">
                                    <div class="pd-social">
