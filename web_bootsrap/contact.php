            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                <form action="">
                  ...
                  <div class="form-group">
                    <input type="text" name="subjek" id="name" class="form-control form-control-user" placeholder="Subjek Anda" required>
                  </div>
                  <div class="form-group">
                ...
                <button type="submit" class="btn btn-success" name="submit">Tambah</button>
                  ...
                  if($subjek){
                    echo "<strong>Subjek: </strong> {$subjek} <br>";
                  }
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Novita Sari E41192406</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
